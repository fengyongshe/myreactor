package com.fys.reactor.myreactor;
...
public class FluxMap<T, R> extends Flux<R> {
  ...
  public FluxMap(Flux<? extends T> source,
  ...
  static final class MapSubscriber<T,R> implements Subscriber, Subscription {
    ...
    public void onNext(Object o) {
      if(done) return;
      actual.onNext(mapper.apply((T) o));
    }
